...
Public Class MainForm
    ...
    Private Sub songsDataGridView_CellFormatting(ByVal sender As Object,
        ...
        If e IsNot Nothing Then
            ...
            If Me.songsDataGridView.Columns(e.ColumnIndex).Name =
            "Release Date" Then
    ...
    Private Sub addNewRowButton_Click(ByVal sender As Object,
    ...
    Private Sub deleteRowButton_Click(ByVal sender As Object,
        ByVal e As EventArgs) Handles deleteRowButton.Click

        If Me.songsDataGridView.SelectedRows.Count > 0 AndAlso
            Not Me.songsDataGridView.SelectedRows(0).Index =
            Me.songsDataGridView.Rows.Count - 1 Then

            Me.songsDataGridView.Rows.RemoveAt(
    ...
    Private Sub PopulateDataGridView()
        ...
        Dim row1 As String() = {"1960", "6", "Fools Rush In",
            "Frank Sinatra", "Nice 'N' Easy"}
        Dim row2 As String() = {"11/11/1971", "1", "One of These Days",
            "Pink Floyd", "Meddle"}
        Dim row3 As String() = {"1988", "7", "Where Is My Mind?",
            "Pixies", "Surfer Rosa"}
        Dim row4 As String() = {"5/1981", "9", "Can't Find My Mind",
            "Cramps", "Psychedelic Jungle"}
        Dim row5 As String() = {"6/10/2003", "13",
